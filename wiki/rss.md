...
> [!tip]
Установите расширение, которое добавляет [кнопку RSS](#rss-button-in-browser) в
...
### [Кнопка RSS в браузере](#rss-button-in-browser)
...
### [Нахождение лент](#feeds-discovery)

Скорее всего, у вас возникнет проблема с наполнением подписок.

- [Установите расширение для кнопки RSS](#rss-button-in-browser) и добавляйте в
...
- В некоторых [сервисах](#online-services) есть директории лент
