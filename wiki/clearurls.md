...
> **Совет:** В Firefox есть встроенная возможность скопировать ссылку без
отслеживающих параметров. Для этого нужно нажать правой кнопкой мыши по ссылке и
нажать на соответствующий пункт в меню.
