...
> **Осторожно:** Отключение и очистка истории просмотра необратима и приведёт к
потере каналов, на которые вы забыли подписаться.
>
...
> **Примечание:** Данный раздел актуален только для пользователей из России.
...
> **Внимание:** Автоматизированный пропуск рекламы может вредить доходам авторов.
...
> **Совет:** Используйте [FFmpeg](/wiki/ffmpeg) для конвертации полученного
видео.
...
> **Осторожно:** Использование альтернативных фронтендов вредит авторам, так как
не показывается реклама и отсутствует статистика. Подумайте о возможности
...
> **Внимание:** Этот раздел нуждается в отдельной статье.
[Узнайте как помочь](https://github.com/KoolTechTricks/pages/blob/main/CONTRIBUTING.md)
