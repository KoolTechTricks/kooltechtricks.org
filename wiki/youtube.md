...
- `<` или `>` — уменьшить или увеличить скорость воспроизведения соответственно.
...
или использовать более удобный интерфейс. Например, они могут содержать
...
пожертвовать деньги автору или купить платную подписку.
