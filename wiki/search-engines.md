...
[Чат с ИИ](https://duckduckgo.com/aichat) — это бесплатная бета-версия функции,
которая позволяет вести анонимные беседы с моделями ИИ. Ваши чаты не
записываются, не хранятся и не используются для тренировки моделей. Все
метаданные, которые содержат персональную информацию (например, ваш IP-адрес),
полностью удаляются перед отправкой запроса поставщику модели.
[Подробнее](https://duckduckgo.com/duckduckgo-help-pages/aichat)
