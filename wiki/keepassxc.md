...
**Базовые функции:**
- [Создание](#creating-database), [открытие](#opening-database) и
[хранение](#storing-database) баз данных на локальном компьютере в формате KDBX
(совместим с KeePass и другими программами);
- Хранение конфиденциальной информации в [записях](#entries),
[организованных по группам](#organizing-entries);
- [Генератор безопасных паролей](#password-generator);
- Автоматический ввод паролей в приложениях;
- [Интеграция с браузерами](#browser-extension) Google Chrome, Mozilla Firefox,
Microsoft Edge, Chromium, Vivaldi, Brave;
- Импорт баз данных из форматов CSV, 1Password и KeePass1.

**Продвинутые функции:**
- [Отчёты по базе данных](#database-reports): состояние паролей,
[Have I Been Pwned?](https://haveibeenpwned.com), статистика;
- Экспорт базы данных в форматы CSV и HTML;
- [Хранение и генерация TOTP](#totp) (одноразовые пароли для двухфакторной
аутентификации);
...
## [Различия между KeePassXC и KeePass](#differences-between-keepass-and-keepassx)
...
[встроенный генератор](#password-generator). Храните этот пароль в надежном
...
#### [Хранение базы данных](#storing-database)
...
#### [Управление базой данных](#managing-database)
...
#### [Отчёты по базе данных](#database-reports)
...
#### [Создание записей](#creating-entries)
...
[встроенного генератора](#password-generator).
...
[расширение для браузера](#browser-extension) определяет наличие аккаунта и
предлагает заполнить данные.
...
#### [Редактирование записей](#editing-entries)
...
#### [Организация записей](#organizing-entries)
