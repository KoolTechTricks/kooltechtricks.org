...
summary = """Программа и библиотека с открытым исходным кодом для записи, \
...
Для операций с видео и аудио используется библиотека FFMpeg — она
