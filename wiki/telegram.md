...
[многофункциональные приложения](#apps). Тем не менее, серверная часть является
проприетарной, а для создания аккаунта требуется номер телефона.

> flags: cover(/media/telegram.webp)
...
[По умолчанию личные чаты не защищены сквозным шифрованием](#messages-are-not-end-to-end-encrypted-by-default).
...
### [Похожие каналы](#similar-channels)
...
### [Заметки и напоминания в избранном](#notes-and-reminders-in-saved-messages)
...
Это не самый лучший и [надёжный](#not-a-reliable-way-to-store-information)
...
[не шифруются](#messages-are-not-end-to-end-encrypted-by-default) на стороне
клиента.
...
### [Платформа переводов](#translations)
...
### [Сообщения не защищены сквозным шифрованием по умолчанию](#messages-are-not-end-to-end-encrypted-by-default)
...
### [Не самый надёжный способ хранения информации](#not-a-reliable-way-to-store-information)
...
### [Forkgram Desktop](#forkgram-desktop)
...
## [Для Android](#for-android)

### [Не из магазина приложений](#not-from-app-store)

![Демонстрация установки Telegram с официального сайта](https://telegram.org/img/tdirect_install.mp4)
...
### [Forkgram Android](#forkgram-android)
