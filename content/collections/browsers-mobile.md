...
выглядит как на настольных браузерах, можно группировать вкладки. Поддерживается
просмотр PDF. ИИ-функции [не будут добавляться](https://vivaldi.com/blog/keep-exploring).
