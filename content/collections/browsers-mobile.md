...
выглядит как на настольных браузерах, можно группировать вкладки. Поддерживаются
расширения и просмотр PDF. ИИ-функции [не будут добавляться](https://vivaldi.com/blog/keep-exploring).
