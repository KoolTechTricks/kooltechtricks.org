...
Некоторые пользователи недолюбливают компанию Brave. Не только из-за интеграции
с криптовалютами, но также из-за
...
- Инъекция реферальных ссылок при посещении криптокошельков.
- Реклама на домашней странице браузера.
- Утечка доменов при использовании режима Инкогнито с Tor.
