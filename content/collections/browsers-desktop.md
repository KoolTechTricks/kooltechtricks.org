...
вкладки, можно настроить [правила маршрутизации](https://floss.social/@zenbrowser/116729995482741653).
Также можно задать контейнер для всего пространства, чтобы изолировать данные
сайтов.
...
(подобно Safari). Можно включить безрамочный режим, при котором интерфейс
браузера скрывается, пока не навести мышку на край окна.
