...
Внешний вид по умолчанию — современный дизайн Nova, но можно вернуть предыдущие
Proton (2021–2026) и Photon (2017–2021). Доступно древовидное отображение
вкладок, подобно расширению Tree Style Tab. Можно открывать отдельные вкладки в
режиме «Инкогнито».
...
пустые окна, в которых вкладки не будут синхронизироваться. Аккаунт Mozilla
позволяет синхронизировать данные между устройствами.
...
- Возможность поделиться вкладками и пространствами с другими пользователями по ссылке.
- Настройка сочетаний клавиш.
- Каталог [модификаций](https://zen-browser.app/mods): темы для Zen.

Удалены лишние службы Mozilla, телеметрия и функции на основе искусственного
интеллекта. Применяется конфигурация [Betterfox]. При первоначальной настройке
предлагается установить uBlock Origin.
...
обозначено краткое описание и уровень конфиденциальности. Поисковые предложения
выключены по умолчанию.

Отсутствует менеджер паролей (предлагается установить сторонние во время
первоначальной настройки) и служба синхронизации. Разработчики считают, что
гораздо безопаснее использовать внешний менеджер паролей и лучше сохранять
данные браузера при себе. Также не поддерживается DRM и отсутствует встроенный
переводчик для Windows и Linux.
