...
Firefox обычно отстаёт по функциям от стандартного Chromium, но в последних
версиях уже поддерживается всё самое необходимое: вертикальные вкладки, группы
вкладок, разделённый просмотр, контейнеры вкладок. Ведётся работа над
веб-приложениями, но пока лучше использовать [стороннее дополнение](https://addons.mozilla.org/firefox/addon/pwas-for-firefox).
...
вкладок. Можно открывать отдельные вкладки в режиме «Инкогнито».
...
- Воспроизводимые медиа отображается снизу.
...
Включена защита от отпечатков браузера, которую можно отключить для отдельных
сайтов.
...
Разработчики придерживаются [открытости и прозрачности](https://helium.computer/blog/transparency).
...
на свой сервер. Через Helium Services могут загружаться обновления браузера,
