...
[блокировщик рекламы Brave]. Добавлен быстрый переключатель сохранения кук и
данных сайта, если вы настроили их очистку при закрытии браузера (аналогично
[LibreWolf](#librewolf)).
...
- «Boosts»: Меняйте цвет и шрифт на сайтах, удаляйте любые элементы.
...
Интерфейс Helium один из самых минималистичных. Доступно несколько режимов
панели вкладок: вертикальный, компактный (в одну строку) и динамический
(подобно Safari). Можно включить режим дзен, когда интерфейс браузера
скрывается, пока не навести мышку на край окна.
...
если вы введёте `!yt` и нажмёте пробел, то введённый поисковой запрос будет
...
Также не поддерживается DRM и отсутствует встроенный переводчик.
...
используется собственный сервер [Lingvanex](https://lingvanex.com).
