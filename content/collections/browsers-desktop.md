...
решения. Поэтому некоторые пользователи переходят на другие браузеры на основе
Firefox, избавленные от решений Mozilla.
...
Удалены лишние службы Mozilla и телеметрия. DNS over HTTPS (DoH) включён на
максимальный уровень. Встроен [блокировщик рекламы Brave]
