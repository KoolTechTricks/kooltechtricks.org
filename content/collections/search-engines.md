...
> [!tip]
> Некоторые поисковые системы поддерживают пересылку запроса — [Bangs]. Это
позволяет перенаправить запрос сразу на нужный сайт. К примеру, чтобы искать в
Википедии, добавьте **!w** к запросу, в YouTube — **!yt**, Google — **!g**,
Яндекс — **!ya** и так далее для тысячи сайтов.
