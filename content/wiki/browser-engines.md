...
рекомендуется не использовать браузеры на основе Chromium.
...
организацией, которая финансируется различными компаниями. При этом они не могут
влиять на функциональность браузера (никаких поисковых систем по умолчанию за
деньги).
