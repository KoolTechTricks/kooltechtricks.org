...
самостоятельно. Альфа-версия для Linux и macOS запланирована на 2026 год.
Разработка идёт стремительными темпами, выходят
[ежемесячные отчёты](https://ladybird.org/news).
...
на языки, безопасные к памяти. В феврале 2026 года глава проекта
