...
Вы можете добавлять сайты в исключения, чтобы их cookie не очищались. Нажмите
...
или блокировать cookie. То же самое доступно и в обычном Firefox.
...
очистку cookie. В этом же разделе настроек ниже уберите галочку с
**«Удалять куки и данные сайтов при закрытии LibreWolf»**.
