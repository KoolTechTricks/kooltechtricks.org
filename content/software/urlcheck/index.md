...
[Эта проблема](https://github.com/TrianguloY/URLCheck/issues/350) возникает
только на устройствах Samsung. Причина её возникновения неизвестна, но иногда
перезагрузка может решить её. Альтернативно можно воспользоваться кнопкой
«Поделиться», чтобы отправить ссылку в нужное приложение.
