...
- Стикеры
    - Можно добавить в коллекцию отдельные стикеры, создавать новые только
через версию для компьютера или [бота](https://i.delta.chat/#9DE7DADDC37828D75499BBDC45CA5FACF50E9B18&a=stickersb%40mehl.cloud&n=StickersBot&i=tHkRoHiugej&s=n0x9TjRcUxo).
...
- Автоматическая отправка истории чата для новых участников групп и каналов.
    ...
    увидят их, как будто были отправлены только что, но с сохранением
...
[Приложения Delta Chat] и [серверы Chatmail](https://github.com/chatmail/relay),
...
шифрования. Видимыми [метаданными] для серверов Chatmail являются только
случайно сгенерированные адреса и размер сообщений.
