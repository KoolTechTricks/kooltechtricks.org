...
[расходует интернет-трафик](https://t.me/kttrickster_pub/52). Кроме того,
существуют [вредоносные сайты](https://t.me/vxunderground/8978), куда можно
попасть через рекламные баннеры или случайно.

Блокировщики контента, такие как uBlock Origin, предназначены для фильтрации
нежелательного содержимого на сайтах. Кроме того, uBlock Origin может выступать
в качестве антивируса: он предотвращает загрузку вредоносных сайтов и нейтрализует
атаки [ClickFix](https://cyberplace.social/@GossiTheDog/117212691813810662).

По умолчанию активно несколько списков фильтров, содержащих адреса элементов
для блокировки отслеживания, рекламы и вирусов. Можно легко создавать и
распространять собственные фильтры.
