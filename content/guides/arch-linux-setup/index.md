...
(кросс-платформенная) или [Rufus] (только Windows). Также можно воспользоваться
...
При переходе между Windows и Linux может сбрасываться время, из-за чего могут
возникать проблемы в различных программах. Устанавливайте корректное время
после каждой загрузки на другую операционную систему.
