...
image: hero.png
imageAlt: >
  Схема, на которой изображены значки GitHub, F-Droid и RuStore.
  От них идут стрелки с APK-файлами в Obtainium.
---
...
с GitHub. В некоторых случаях может потребоваться переопределить источник и
изменить параметры.
...
[оптимизацию MIUI](https://androidinsider.ru/polezno-znat/zachem-otklyuchat-optimizacziyu-xiaomi-i-kak-eto-sdelat-na-miui-ili-hyperos.html#__miui).
...
Иногда на сайтах можно встретить специальные ссылки, начинающиеся на
`obtainium://`, а также значки Obtainium. Вот, например, ссылка на добавление
...
Если у вас установлен Obtainium, и вы перейдёте по таким ссылкам, то вам сразу
