...
[приложений](/software/obtainium/#безопасность) перед первой установкой.
...
приложения. Следует проверять ссылки и параметры конфигурации перед первой
установкой во избежание получения вредоносного ПО.
...
его заново (с другой подписью, если приложение не установлено в других профилях).

Вы можете удалить приложения с устройства, но оставить в списке Obtainium. По
умолчанию они будут проверяться на наличие обновлений (за это отвечает настройка
...
Obtainium и добавьте его заново из другого источника. Подпись приложения из
нового источника должна совпадать.

## Экспорт и импорт данных

В меню настроек есть раздел «Данные», где можно экспортировать и импортировать
список приложений и настроек.

Для начала выберите каталог для экспорта, где будут храниться резервные копии
Obtainium. Можно сохранять вручную или включить автоматический экспорт при
изменении каких-либо данных.

Затем здесь можно импортировать данные из файла или списка URL-адресов.
