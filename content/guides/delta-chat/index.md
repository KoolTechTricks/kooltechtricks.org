...
Нажмите на значок телефона в личном чате, чтобы позвонить. Групповые звонки и
демонстрация экрана пока не поддерживаются, для этого рекомендуем [Jitsi Meet].
...
сообщения через него. Читайте подсказки в интерфейсе.
