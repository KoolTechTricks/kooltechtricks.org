...
другим пользователям. На данный момент не поддерживаются реакции, комментарии,
закреплённые сообщения. Новые участники увидят только 10 последних сообщений,
но вы можете отправить старые, нажав «Отправить повторно».
