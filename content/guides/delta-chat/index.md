...
кого-нибудь или найти самостоятельно. Есть [публичный список серверов], адреса
выделены жёлтым.
...
Процесс добавления релеев аналогичен [созданию профиля](#создать-профиль), но
перед этим переключитесь на свой профиль. *(В версии для iOS это пока не
работает, поэтому придётся добавить через настройки ниже.)*
